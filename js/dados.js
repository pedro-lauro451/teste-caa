document.addEventListener('DOMContentLoaded', function () {
    fetch('default/header.html')
        ...
        .then(data => {
            ...
            headerText.innerText = 'Integrando diversas plataformas e IA para coletar, processar e transformar dados em insights';
            const image = document.getElementById('header');
            image.style.backgroundImage = `url(../images/dados-main-banner.png)`
