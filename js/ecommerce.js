document.addEventListener('DOMContentLoaded', function () {
    fetch('default/header.html')
        ...
        .then(data => {
            ...
            headerText.innerText = 'Implementação e sustentação contínua para plataformas de e-commerce';
            const image = document.getElementById('header');
            image.style.backgroundImage = `url(./images/ecommerce-main-banner.png)`
